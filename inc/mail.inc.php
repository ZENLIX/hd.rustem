...
<table width="100%" cellpadding="3" cellspacing="0">
  <tbody>
	...
	font-size: 12px;"><p style="font-family: Arial, Helvetica, sans-serif; font-size:11px; text-align:center;"> <a href='{$CONF['hostname']}/inc/ticket.php?hash={$h}'>{$MAIL_2link}</a>.</p></td>
    </tr>
  </tbody>
</table>
<br />
