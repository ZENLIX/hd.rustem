...
'NAVBAR_live'=>'Активность пользователей',
'T_from'=>'с',
...
'FILES_info'=>'В данном разделе вы можете просмотреть все прикреплённые файлы к заявкам, а так же удалить их.',
'FILES_name'=>'Имя файла',
'FILES_ticket'=>'Заявка',
'FILES_size'=>'Размер',

'Live_title'=>'Активность пользователей',
'Live_name'=>'ФИО',
'Live_status'=>'Статус',
'Live_status_on'=>'On-line',
'Live_status_off'=>'Off-line',
'Live_info'=>'В данном разделе вы можете посмотреть статус всех пользователей системы.',
