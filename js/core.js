...
var result="";
    ...
    /*$("#user_login").change(function() {
     ...
     type: "POST",
     url: "client.inc.php",
     data: "new_client_info=&new_client_login="+$(this).val(),
     success: function(html) {
     $("#alert_add").hide().html(html).fadeIn(500);
     $('#username').editable({
     inputclass: 'input-sm',
    ...
    $("#user_login").autocomplete({
        max: 10,
        minLength: 2,
        source: "json.php?login",
        focus: function(event, ui) {
            $("#user_login").val(ui.item.label);
            return false;
        },
        select: function(event, ui) {
            $("#fio").val(ui.item.label2);
            $("#user_fio").html(ui.item.label2);
            $("#user_info").hide().fadeIn(500);
            $("#alert_add").hide();
            $("#client_id_param").val(ui.item.value);
            $.ajax({
...
$('#summernote').summernote({
    ...
    /*
     ...
     click - все остальные 0
     click_def - всё в дефолт

     */

    /*
     $('body').on('click', 'div#sort_init', function(event) {
     event.preventDefault();
     var act=$(this).attr('action');
     var oo=$("#curent_page").attr('value');
     var pt=$("#page_type").attr('value');
     if (act == "none") {//$("div#sort_prio_text").html("<i class=\"fa fa-caret-down\"></i>"); 
     $.ajax({
     type: "POST",
     url: "actions.php",
     data: "mode=sort_init"+
     ...
     if (act == "asc") {//$("div#sort_prio_text").html("<i class=\"fa fa-caret-up\"></i>"); 
     $.ajax({
     type: "POST",
     url: "actions.php",
     data: "mode=sort_init"+
     ...
     if (act == "desc") { //$("div#sort_prio_text").html("");
     $.ajax({
     type: "POST",
     url: "actions.php",
     data: "mode=sort_init"+
     ...
     $('body').on('click', 'div#sort_cli', function(event) {
     event.preventDefault();
     var act=$(this).attr('action');
     var oo=$("#curent_page").attr('value');
     var pt=$("#page_type").attr('value');
     ...
     $('body').on('click', 'div#sort_prio', function(event) {
     event.preventDefault();
     var act=$(this).attr('action');
     var oo=$("#curent_page").attr('value');
     var pt=$("#page_type").attr('value');
     ...
     $('body').on('click', 'div#sort_id', function(event) {
     event.preventDefault();
     var act=$(this).attr('action');
     var oo=$("#curent_page").attr('value');
     var pt=$("#page_type").attr('value');
     ...
     $('body').on('click', 'div#sort_subj', function(event) {
     event.preventDefault();
     var act=$(this).attr('action');
     var oo=$("#curent_page").attr('value');
     var pt=$("#page_type").attr('value');
