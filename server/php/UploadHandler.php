...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'readfile_chunk_size' => 20 * 1024 * 1024, // 20 MiB
            // Defines which files can be displayed inline when downloaded:
            'inline_file_types' => '/\.(gif|jpe?g|png)$/i',
            // Defines which files (based on their names) are accepted for upload:
            'accept_file_types' => '/(\.|\/)(gif|jpe?g|png|zip|rar|gz|docx|pdf|txt|xls|doc|xlsx)$/i',
...
$ext=$path_parts['extension'];
        ...
        //$good_name=explode('.', $name);
        $name=$name."_".generateRandomString().".".$ext;
        
//$query_add_ticket_log = "insert into files (name) VALUES ('$name')";
